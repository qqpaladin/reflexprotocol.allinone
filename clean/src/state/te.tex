...
A critical question which arises is how much TE can enhance network efficiency, and whether it brings a significant added value. 
%this sentence is long and confusing. break it down.
...
\epsfig{file=img/state/te/mplsHeader, width=4.5in}
\caption{
...
\epsfig{file=img/state/te/mplsTunnel, width=4.5in}
\caption{
...
\epsfig{file=img/state/te/texcpArchitecture, width=4.5in}
\caption{
...
\begin{figure}[h]
\begin{center}
\epsfig{file=img/state/te/texcpProbe, width=2in}
\caption{
  A simple architecture of an ISP network.
  \label{fig:texcp2}
}
